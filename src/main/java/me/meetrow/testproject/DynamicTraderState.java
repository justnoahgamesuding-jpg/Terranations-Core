...
public final class DynamicTraderState {
    private final UUID traderId;
    private final UUID entityId;
    private final String hostCountryKey;
    private final String traderName;
    private final Profession specialtyProfession;
    ...
    public DynamicTraderState(
            UUID traderId,
            UUID entityId,
            String hostCountryKey,
            String traderName,
            Profession specialtyProfession,
            String worldName,
            double x,
            double y,
            double z,
        ...
        this.specialtyProfession = specialtyProfession;
    ...
    public Profession getSpecialtyProfession() {
        return specialtyProfession;
    }
