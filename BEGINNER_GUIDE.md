...
This is the player-facing quick start for Terra.
...
- `Miner`
  Mining, excavation, ore work, and support-heavy digging.
- `Lumberjack`
  Tree harvesting, wood supply, and sapling-focused progression.
- `Farmer`
  Farmland, crops, food crafting, and climate-sensitive growth.
- `Builder`
...
- You level up by doing profession-specific actions.
...
Farming is not universal in Terra.

Crop and sapling growth depends on:

- temperature
- season
- rain
- altitude
- local climate and biome conditions

Practical rule:

- if crops are growing badly, the location may be wrong even if the soil and light look fine

## Building and Mining Matter Too

Terra uses support and stability rules.

That means:

- unsupported shafts are risky
- long floating roofs and bridges are risky
- heavy walls and stacked columns need support
- loose soil and weak terrain can collapse

Safer building patterns use:
...
- Watch where crops grow well.
- Rain and climate help more than brute force.
- Food crafting also contributes to progression.

### Miner

- Do not open huge unsupported voids.
- Think in terms of mines, supports, and controlled excavation.

### Lumberjack

- Replant consistently.
- Sapling success still depends on the environment.

### Builder

- Expect progression to reward deliberate settlement work.
- Large structures need believable support.
